3ddea40a80cac970ed9d952636bf4d0c49512fc6<?php
	...
	$strings['404 - Not Found'] = '404 - Страница не найдена';
	$strings['A blank "%report_issue%" page with a link to the reported issue at the top will be shown after the issue is reported'] = 'Пустая страница "%% report_issue" с ссылкой на отправленный запрос будет показана после отправки запроса';
	$strings['About %sitename%'] = 'О %sitename%';
	$strings['About this project'] = 'О проекте';
	$strings['Access'] = 'Доступ';
	$strings['Access method'] = 'Метод доступа';
	$strings['Access to this issue is restricted'] = 'Доступ к этому отчету ограничен';
	$strings['Account details'] = 'Информация о аккаунте';
	$strings['Account information saved'] = 'Информация о аккаунте сохранена';
	$strings['Account name:'] = 'Имя аккаунта:';
	$strings['Account type'] = 'Тип аккаунта';
	$strings['Actions'] = 'Действия';
	$strings['Actions available'] = 'Действия отсутствуют';
	$strings['Activated'] = 'Активировано';
	$strings['Active'] = 'Активность';
	...
	$strings['Add a comment if one is specified'] = 'Добавить комментарий если он отмечен';
	$strings['Add a component'] = 'Добавить компонент';
	$strings['Add affected item'] = 'Добавить поврежденный элемент';
	$strings['Add a link'] = 'Добавить ссылку';
	$strings['Add an edition'] = 'Добавить выпуск';
	$strings['Add an empty workflow'] = 'Добавить пустой этап';
	$strings['Add a new issue type'] = 'Добавить новый тип запроса';
	$strings['Add an existing component'] = 'Добавить существующий компонент';
	$strings['Add an item to the menu'] = 'Добавить элемент в это меню';
	$strings['Add an option'] = 'Добавить параметр';
	$strings['Add a step'] = 'Добавить шаг';
	$strings['Add a task to this user story'] = 'Добавить задачу пользователю';
	$strings['Add a user or team'] = 'Добавить пользователя или команду';
	$strings['Add a view to dashboard'] = 'Добавить на панель';
	$strings['Add comment and save changes'] = 'Добавить комментарий и сохранить изменения';
	$strings['Add custom field'] = 'Добавить свое поле';
	$strings['Add external login'] = 'Добавить внешний логин';
	$strings['Add filter'] = 'Добавить фильтр';
	$strings['Adding client, please wait'] = 'Добавление клиента, подождите';
	$strings['Adding component, please wait'] = 'Добавление компонента, подождите';
	$strings['Adding edition, please wait'] = 'Добавление выпуск, подождите';
	$strings['Adding group, please wait'] = 'Добавление группы, подождите';
	$strings['Adding project, please wait'] = 'Добавление проекта, подождите';
	$strings['Adding sprint, please wait'] = 'Добавление спринта, подождите';
	$strings['Adding team, please wait'] = 'Добавление команды, подождите';
	...
	$strings['Adding user story, please wait'] = 'Добавление пользовательской истории, пожалуйста подождите';
	$strings['Add issue'] = 'Добавить запрос';
	$strings['Additional'] = 'Дополнительно';
	$strings['Additional actions available'] = 'Доступны дополнительные действия';
	...
	$strings['Add one or more components from the list of available components'] = 'Добавить один или более компонентов из списка доступных компонентов';
	$strings['Add one or more editions from the list of available editions'] = 'Добавить один или более выпусков из списка доступных компонентов';
	$strings['Add one or more releases from the list of available releases'] = 'Добавить один или более релизов из списка доступных релизов';
	$strings['Add outgoing transition'] = 'Добавить исходящую транзакцию';
	$strings['Add outgoing transition from step "%step_name%"'] = 'Добавить исходящую транзакция с шага "%step_name%"';
	$strings['Add people to this project'] = 'Добавить людей в этот проект';
	...
	$strings['Add transition'] = 'Добавить транзакцию';
	$strings['Add transition action'] = 'Добавить действие транзакции';
	$strings['%add_transition% or %cancel%'] = '%add_transition% или %cancel%';
	$strings['Add user'] = 'Добавить пользователя';
	$strings['Add workflow'] = 'Добавить этап';
	$strings['Advanced settings'] = 'Расширенные настройки';
	$strings['Affected build removed'] = 'Поврежденная сборка удалена';
	$strings['Affected build updated'] = 'Поврежденная сборка удалена';
	$strings['Affected component removed'] = 'Поврежденный компонент удален';
	$strings['Affected components'] = 'Поврежденные компоненты';
	$strings['Affected component(s)'] = 'Поврежденный компонент(ы)';
	$strings['Affected component updated'] = 'Поврежденный компонент обновлен';
	$strings['Affected edition removed'] = 'Поврежденный выпуск удален';
	$strings['Affected editions'] = 'Поврежденные выпуски';
	$strings['Affected edition(s)'] = 'Поврежденный выпуск(и)';
	$strings['Affected edition updated'] = 'Поврежденный выпуск обновлен';
	$strings['Affected issues'] = 'Поврежденные запросы';
	$strings['Affected item'] = 'Поврежденный элемент';
	$strings['Affected items (%count%)'] = 'Поврежденные элементы (%count%)';
	$strings['Affected releases'] = 'Поврежденные релизы';
	$strings['Affected release(s)'] = 'Поврежденный релиз(ы)';
	$strings['A file was uploaded. %link_to_file%'] = 'Файл был загружен. %link_to_file%';
	$strings['A file was uploaded. %link_to_file% This comment was attached: %comment%'] = 'Файл был загружен. %link_to_file% Комментарий прикреплен: %comment%';
	...
	$strings['All new user accounts will be created by an admin'] = 'Все новые пользовательские аккаунты будут созданы администратором';
	$strings['Allow "CamelCased" links'] = 'Разрешить ссылки "CamelCased"';
	$strings['Allow custom workflows'] = 'Разрешить свои этапы';
	$strings['Allowed'] = 'Разрешено';
	$strings['Allowed extensions'] = 'Разренные расширения';
	$strings['Allowed groups'] = 'Разрешенные группы';
	...
	$strings['An authentication error occured. Please reload your page and try again'] = 'Произошла ошибка аутентификации. Пожалуйста, обновите  страницу и попробуйте снова';
	...
	$strings['An error occured when adding or updating the release'] = 'Произошла ошибка при добавлении или обновлении релиза';
	$strings['An error occured when relating issues: %error%'] = 'Произошла ошибка при передаче запроса: %error%';
	$strings['An error occured when saving the file'] = 'Произошла ошибка при сохранении файла';
	...
	$strings['An error occurred:'] = 'Произошла ошибка:';
	$strings['An error occurred when trying to assign user/team to this project'] = 'Произошла ошибка при попытке добавить пользователя/команду в проект';
	$strings['A new milestone has been reached'] = 'Достигнут новый этап';
	...
	$strings['An internal error has occured'] = 'Произошла внутренняя ошибка';
	$strings['An internal error occured'] = 'Произошла внутренняя ошибка';
	$strings['Anonymous access'] = 'Анонимный доступ';
	$strings['Another article with this name already exists'] = 'Существуют другие записи с таким именем';
	$strings['An unhandled error occured'] = 'Произошла не обработанная ошибка';
	$strings['An unhandled error occured with the upload'] = 'Произошла не обработанная ошибка при загрузке';
	...
	$strings['A password has been autogenerated for you. To log in, use the following password:'] = 'Пароль для вас сгенерирован автоматически. Войдите, используя следующий пароль:';
	$strings['Appearance'] = 'Appearance';
	$strings['Apply'] = 'Подтвердить';
	$strings['A project with the same key already exists'] = 'Проект с таким ключом уже существует';
	$strings['Archived'] = 'Добавлено в архив';
	$strings['ARCHIVED'] = 'ДОБАВЛЕНО В АРХИВ';
	...
	$strings['Archive this project?'] = 'Добавить проект в архив?';
	$strings['Are you really sure you want to delete this item?'] = 'Вы уверены что хотите удалить этот элемент?';
	$strings['Are you sure?'] = 'Вы уверены?';
	$strings['Are you sure you want to completely delete this step? This action cannot be reverted.'] = 'Вы уверены, что хотите полностью удалить этот шаг? Вернуть это действие будет невозможно.';
	$strings['Are you sure you want to delete ALL outgoing transitions from this step? This action cannot be reverted.'] = 'Вы уверены, что хотите удалить ВСЕ внешние транзакции с этого шага? Вернуть это действие будет невозможно.';
	$strings['Are you sure you want to restore this revision?'] = 'Are you sure you want to restore this revision?';
	$strings['Article comments (%count%)'] = 'Комментарии к статье (%count%)';
	$strings['Article content'] = 'Содержание статьи';
	...
	$strings['%article_name% ~ History'] = '%article_name% ~ История';
	$strings['%article_name% permissions'] = '%article_name% права доступа';
	$strings['%article_name% ~ Permissions'] = '%article_name% ~ Права доступа';
	...
	$strings['Assigned teams'] = 'Назначить команды';
	...
	$strings['Available issue fields'] = 'Доступные поля запроса';
	...
	$strings['A validation error occured: %error%'] = 'Произошла ошибка валидации: %error%';
	...
	$strings['Blank workflow'] = 'Пустой этап';
	...
	$strings['Clone this group'] = 'Клонировать эту группу';
	$strings['Clone this team'] = 'Клонировать эту команду';
	$strings['Clone this user group'] = 'Clone this user group';
	$strings['Clone this user team'] = 'Clone this user team';
	$strings['Cloning group, please wait'] = 'Клонирование группы, подождите';
	$strings['Cloning team, please wait'] = 'Клонирование команды, опдождите';
	$strings['Close'] = 'Закрыть';
	$strings['Close and reload'] = 'Закрыть и перезагрузить';
	$strings['Closed'] = 'Закрыто';
	$strings['Closed, but editable'] = 'Закрыто, но можно редактировать';
	...
	$strings['Comment deleted!'] = 'Комментарий удален!';
	$strings['Comment edited!'] = 'Комментарий отредактирован!';
	$strings['Comment ID is invalid'] = 'Неверный ID комментарий';
	$strings['Comment posted by %user%'] = 'Комментарий оставлен %user%';
	$strings['Comment posted on behalf of %user%'] = 'Comment posted on behalf of %user%';
	$strings['Comments (%count%)'] = 'Комментарии (%count%)';
	...
	$strings['Configure authentication'] = 'Настроить аутентификацию';
	$strings['Configure columns'] = 'Configure columns';
	$strings['Configure dashboard'] = 'Configure dashboard';
	$strings['Configure data types'] = 'Настроить типы данных';
	$strings['Configure icons'] = 'Настроить иконки';
	$strings['Configure issue fields'] = 'Настроить поля запросов';
	$strings['Configure issue types'] = 'Настроить типы запросов';
	$strings['Configure module'] = 'Настрить модуль';
	$strings['Configure module "%module_name%"'] = 'Настроить модуль "%module_name%"';
	$strings['Configure modules'] = 'Настроить модули';
	$strings['Configure permissions'] = 'Настроить права доступа';
	$strings['Configure projects'] = 'Настроить проекты';
	$strings['Configure roles'] = 'Настроить роли';
	$strings['Configure scopes'] = 'Configure scopes';
	$strings['Configure scope "%scope_name%"'] = 'Configure scope "%scope_name%"';
	$strings['Configure settings'] = 'Настроить параметры';
	$strings['Configure The Bug Genie'] = 'Настроить The Bug Genie';
	$strings['Configure uploads &amp; attachments'] = 'Настроить загружаемые &amp; вложения';
	...
	$strings['Email password:'] = 'Пароль электронной почты:';
	...
	$strings['Enable autoassignment'] = 'Включить автоподтверждение';
	$strings['Enabled'] = 'EВключено';
	...
	$strings['Enter your AOL screenname'] = 'Введите имя пользователя AOL';
	$strings['Enter your ClickPass username'] = 'Введите имя пользователя ClickPass';
	...
	$strings['Enter your Flickr username'] = 'Введите имя пользователя Flickr';
	...
	$strings['Enter your Wordpress.com username'] = 'Введите имя пользователя Wordpress.com';
	$strings['Error details:'] = 'Описание ошибки:';
	...
	$strings['Feature request'] = 'Запрос функционала';
	$strings['Field'] = 'Поле';
	$strings['%field% is not %value%'] = '%field% не %value%';
	...
	$strings['%field% is %value%'] = '%field% это %value%';
	$strings['Field label'] = 'Ярлык поля';
	$strings['Field name'] = 'FИмя поля';
	$strings['File blob/view page'] = 'File blob/view page';
	$strings['File issue'] = 'Запрос файла';
	$strings['File log page'] = 'Страница лога файла';
	...
	$strings['Files already attached'] = 'Файлы уже добавлены';
	...
	$strings['Frontpage'] = 'Главная страница';
	$strings['Full name'] = 'Полное имя';
	$strings['Full name attribute'] = 'Full name attribute';
	$strings['General'] = 'Основное';
	$strings['General configuration'] = 'Основная конфигурация';
	$strings['General permissions'] = 'Основные права доступа';
	$strings['General settings'] = 'Основные настройки';
	$strings['General wiki settings'] = 'Основные настройки wiki';
	$strings['Generate random new password'] = 'Сгенерировать случайный пароль';
	...
	$strings['Google account'] = 'Аккаунт Google';
	...
	$strings['Gravatar user icons'] = ' Пользовательские иконки Gravatar';
	$strings['Group class'] = 'Group class';
	$strings['Group: %group_name%'] = 'Группа: %group_name%';
	$strings['Group members attribute'] = 'Атрибуты пользователей группы';
	...
	$strings['Last checked: %time%'] = 'Последняя првоерка: %time%';
	$strings['Last page'] = 'Последняя страница';
	$strings['Last reported issues:'] = 'Последний оставленный запрос:';
	$strings['Last updated'] = 'Последнее обновление';
	$strings['Last updated at %time%, by %user%'] = 'последний раз обновлено %time% пользователем %user%';
	$strings['Last updated %updated_at%'] = 'Последний раз обновлено %updated_at%';
	$strings['Last user activity was at %time%'] = 'Пользователь был активен %time%';
	$strings['Latest downloads'] = 'Последние загрузки';
	$strings['LDAP support is not installed'] = 'Поддержка LDAP не установлена';
	$strings['Lead by'] = 'Управляется';
	$strings['Lead by: %name%'] = 'Управляющий: %name%';
	...
	$strings['Manage projects'] = 'Управление проектами';
	$strings['Mark as blocking the next release'] = 'Mark as blocking the next release';
	$strings['Mark as duplicate'] = 'Пометить как повтор';
	...
	$strings['Mark as not duplicate'] = 'Пометить как не повтор';
	...
	$strings['Members of %team%'] = 'Участник команды %team%';
	...
	$strings['Milestone type:'] = 'Тип этапа:';
	...
	$strings['Modules'] = 'Подули';
	$strings['Modules / addons'] = 'Модули/дополнения';
	$strings['Module settings'] = 'Настройки модуля';
	$strings['Module-specific permissions'] = 'Права доступа модуля';
	...
	$strings['New group name'] = 'Имя новой группы';
	...
	$strings['New password (repeat it)'] = 'Новый пароль (repeat it)';
	$strings['New team name'] = 'Имя новой команды';
	$strings['New user accounts'] = 'Аккаунты новых пользователей';
	$strings['New users'] = 'Новые пользователи';
	$strings['New users will automatically be added to this group'] = 'Новые пользователи будут автоматически добавлены в эту группу';
	$strings['New version released'] = 'Выпущена новая версия';
	$strings['New workflow scheme:'] = 'Новая схема этапа:';
	$strings['Next page'] = 'Следующая страница';
	$strings['Nickname'] = 'Никнейм';
	$strings['No'] = 'Нет';
	...
	$strings['Other OpenID provider'] = 'Другой провайдер OpenID';
	...
	$strings['Owned by team'] = 'Команда-владелец';
	...
	$strings['Show complete timeline'] = 'Показать завершенный таймлайн';
	$strings['Show current version'] = 'Показать текущую версию';
	$strings['Show details'] = 'Показать подробности';
	$strings['Show / edit available choices'] = 'Показать/редактировать варианты';
	$strings['Show / edit issue type associations'] = 'Show / edit issue type associations';
	$strings['Show / edit issue type settings'] = 'Показать/редактировать настройки типов запроса';
	...
	$strings['Show milestone details'] = 'Показать описание этапа';
	$strings['Show milestone overview'] = 'Показать обзор этапа';
	$strings['Show more'] = 'Показать еще';
	$strings['Show more actions'] = 'Показать еще действия';
	$strings['Show more detailed permissions'] = 'Show more detailed permissions';
	$strings['Show more details'] = 'Показать подробности';
	$strings['Show more statistics'] = 'Показать статистику';
	$strings['Show my email address to others'] = 'Показывать пользователям мой адрес электронной почты';
	$strings['Show my issues'] = 'Показать мои запросы';
	$strings['Show newly created users'] = 'Показать новых пользователей';
	$strings['Show open issues assigned to me'] = 'Показать открытые запросы адресованные мне';
	$strings['Show open issues assigned to my teams'] = 'Show open issues assigned to my teams';
	$strings['Show project downloads'] = 'Показать загрузки проекта';
	$strings['Show project list on frontpage'] = 'Показывать список проектов на главной';
	$strings['Show roles'] = 'Показать роли';
	$strings['Show step info'] = 'Показать информацию о шаге';
	...
	$strings['This issue'] = 'Этот запрос';
	$strings['This issue cannot be updated'] = 'Этот запрос не может быть обновлен';
	$strings['This issue does not depend on any other issues'] = 'This issue does not depend on any other issues';
	$strings['This issue does not exist'] = 'Этот запрос не существует ';
	...
	$strings['This issue has been closed'] = 'Этот запрос был закрыт';
	...
	$strings['This issue has been deleted'] = 'Этот запрос был удален';
	...
	$strings['This milestone is overdue'] = 'Этот этап завершен';
	...
	$strings['This username already exists'] = 'Такой пользователь существует';
	$strings['This username does not exist'] = 'Такого пользователя не существует';
	$strings['This username is already taken'] = 'This username is already taken';
	$strings['This username is in use'] = 'Это имя пользователя уже используется';
	...
	$strings['Unactivated users'] = 'Неактивированный прользователь';
	$strings['Unarchive project'] = 'Неактивированный проект';
	...
	$strings['Update issue details'] = 'Обновить описание запроса';
	$strings['Update milestone'] = 'Обновить этап';
	...
	$strings['Update (regenerate) milestone details'] = 'Обновить (сгенерировать) описание этапа';
	...
	$strings['%user% wrote:'] = '%user% написал:';
	...
	$strings['Workflows'] = 'Этапы';
	$strings['Workflow scheme'] = 'Схема этапов';
	$strings['Workflow scheme changed and issues updated'] = 'Схема этапов изменена запрос обновлен';
	$strings['Workflow schemes'] = 'Схемы этапов';
	$strings['Workflow scheme "%workflow_scheme_name%"'] = 'Схема этапов "%workflow_scheme_name%"';
	$strings['Workflow step "%step_name%"'] = 'Шаг этапа "%step_name%"';
	...
	$strings['You are not allowed to access this page'] = 'У Вас нет доступа к этой странице';
	...
	$strings['You cannot clone this team'] = 'Вы не можете копировать эту команду';
	$strings['You cannot delete a step with incoming transitions'] = 'You cannot delete a step with incoming transitions';
	$strings['You cannot delete the default groups'] = 'Вы не можете удалить группы, установленные по умолчанию';
	...
	$strings['You cannot delete the last step'] = 'Вы не можете удалить последний шаг';
	$strings['You cannot delete this client'] = 'Вы не можете удалить этого клиента';
	$strings['You cannot delete this group'] = 'Вы не можете удалить эту группу';
	$strings['You cannot delete this system user'] = 'Вы не можете удалить этого пользователя системы';
	$strings['You cannot delete this team'] = 'Вы не можете удалить эту команду';
	$strings['You cannot delete this user'] = 'Вы не можете удалить этого пользователя';
	$strings['You cannot edit this client'] = 'Вы не можете удалить этого клиента';
	$strings['You can not remove items from this issue'] = 'Вы не можете удалить элемент из этого запроса';
	...
	$strings['You can read more about how the workflow in The Bug Genie works and is set up in %link_to_wiki_workflow%.'] = 'Вы можете прочитать больше о том, как работает поток работ в The Bug Genie, а так же об его  структуре здесь: %link_to_wiki_workflow%.';
	...
	$strings['You can use simple formatting tags for underlined text (<b></b>) or strikethrough (<strike></strike>).'] = 'Вы можете использовать теги простого форматирования для подчеркивания текста (<b></b>) или для зачеркивания (<strike></strike>).';
	$strings['You currently have version %thebuggenie_version% of The Bug Genie.'] = 'Теперь у Вас есть версия The Bug Genie %thebuggenie_version% .';
	...
	$strings['You do not have access to removing links'] = 'У Вас нет доступа к удалению ссылок';
	$strings['You do not have access to this action'] = 'У Вас нет доступа к этому действию';
	$strings['You do not have access to this project'] = 'У Вас нет доступа к этому проекту';
	$strings['You do not have access to this release'] = 'У Вас нет доступа к этому выпуску';
	...
	$strings['You don\'t have access to add project editions'] = 'У Вас нет доступа к добавлению версий проектов';
	$strings['You don\'t have access to add projects'] = 'У Вас нет доступа к добавлению проектов';
	$strings['You don\'t have access to add releases'] = 'У вас нет доступа к добавлению релизов';
	$strings['You don\'t have access to archive projects'] = 'У Вас  нет доступа к архиву проектов';
	$strings['You don\'t have access to enter a description'] = 'У Вас нет доступа к вводу описания';
	...
	$strings['You don\'t have access to remove projects'] = 'У Вас нет доступа к удалению пректов ';
	...
	$strings['You have to enter a description in the "%description%" field'] = 'Вам нужно ввести описание в поле "%description%" ';
	$strings['You have to enter something in the "%steps_to_reproduce%" field'] = 'Вам нужно ввести что-нибудь в поле "%steps_to_reproduce%" ';
	...
	$strings['You have to provide a reason for the changes'] = 'Вам нужно указать причину для изменений';
	$strings['You have to provide a title'] = 'Вам нужно указать заголовок';
	$strings['You have to provide a valid link id'] = 'You have to provide a valid link id';
	$strings['You have to select a valid issue type'] = 'Вам нужно выбрать правильный итоговый тип';
	$strings['You have to select a valid project'] = 'Вам нужно выбрать правильный проект';
	$strings['You have to specify a name for the saved search'] = 'You have to specify a name for the saved search';
	$strings['You have to specify a name for this role'] = 'Вам нужно указать имя для этой роли';
	$strings['You have to specify a title'] = 'Вам необходимо указать заголовок';
	...
	$strings['You must provide a role name'] = 'Вам необходимо указать название роли';
	$strings['You must provide a valid milestone name'] = 'Вам необходимо указать корректное имя этапа';
	$strings['You need a valid user account to access any content'] = 'You need a valid user account to access any content';
	$strings['You need to add a sender name and address'] = 'Вам необходимо указать имя и адрес отправителя';
	$strings['You need to add at least one recipient'] = 'Вам необходимо указать хотя бы одного получателя';
	$strings['You need to enable javascript for The Bug Genie to work properly'] = 'Вам необходимо включить javascript для корректной работы The Bug Genie';
	$strings['You need to fill out all fields correctly.'] = 'Вам необходимо корректно заполнить все поля.';
	$strings['You need to log in to access this site'] = 'Вам необходимо войти для использования сайта';
	$strings['You need to provide a custom field key that already exists'] = 'Вам необходимо предоставить ключ пользовательскому полю чтобы использовать';
	$strings['You need to provide a unique custom field name (key already exists)'] = 'Вам необходимо предоставить уникальное имя пользовательскому полю (ключ уже используется)';
	$strings['You need to specify a name for the new component'] = 'Вы должны указать имя для нового компонента';
	$strings['You need to specify a name for the new edition'] = 'Вы должны указать имя для нового выпуска';
	$strings['You need to specify a name for the release'] = 'Вы должны указать имя для этого релиза';
	$strings['You need to specify a name for this component'] = 'Вы должны указать имя для этого компонента';
	$strings['You need to specify a name for this edition'] = 'Вы должны указать имя для этого выпуска';
	$strings['You need to specify a release'] = 'Вы должны указать релиз';
	$strings['You need to specify a valid article name'] = 'Вы должны указать правильное название статьи';
	$strings['Your account'] = 'Ваш аккаунт';
	$strings['Your account has been activated! You can now log in with the username %user% and the password in your activation email.'] = 'Ваш аккаунт актвирован! Вы можете войти сейчас под именем %user% и паролем, указанным в активационном письме.';
	$strings['Your account in The Bug Genie has been added to a new scope'] = 'Ваш аккаунт в The Bug Genie has been added to a new scope';
	$strings['Your Blogger account'] = 'Ваш аккаунт на Blogger';
	$strings['Your changes have been saved'] = 'Ваши изменения сохранены';
	$strings['Your ClaimID username'] = 'Имя пользователя на ClaimID';
	$strings['Your dashboard'] = 'Your dashboard';
	$strings['Your drafts'] = 'Your drafts';
	$strings['You\'re not allowed to change your password.'] = 'Вам запрещено изменять пароль.';
	$strings['Your friends will appear here'] = 'Ваши друзья появятся здесь';
	$strings['Your issues'] = 'Ваш запрос';
	$strings['Your Launchpad username'] = 'Имя пользователя на Launchpad';
	$strings['Your new password has been saved'] = 'Ваш новый пароль сохранен'; 
	$strings['Your password was not accepted by the server'] = 'Ваш пароль был не принят сервером';
	$strings['Your projects'] = 'Ваши проекты';
	$strings['Your saved searches for this project'] = 'Your saved searches for this project';
	$strings['Your security key is %securitykey%'] = 'Ваш секретный ключ %securitykey%';
	$strings['Your Technorati username'] = 'Имя пользователя на Technorati';
	$strings['Your Verisign username'] = 'Имя пользователя на Verisign';
	$strings['Your Vidoop username'] = 'Имя пользователя на Vidoop';
	$strings['You\'ve chosen the username \'%username%\''] = 'Вы выбрали имя \'%username%\'';
	$strings['You will be teamed up with this user'] = 'Вы будете объединены с этим пользователем';
